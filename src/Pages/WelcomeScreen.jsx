        ...
        >
          ...
          <div className="relative min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-4xl mx-auto">
              ...
              >
                <a
                  href="https://www.bandungcoding.com"
                  className="inline-flex items-center justify-center gap-2 px-4 py-2 sm:px-6 sm:py-3 rounded-full relative group hover:scale-105 transition-transform duration-300"
                  target="_blank"
                ...
                >
                  ...
                  <div className="relative flex items-center gap-2 text-base sm:text-lg md:text-xl lg:text-2xl whitespace-nowrap">
                    <Globe className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0 text-indigo-600" />
                    <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent font-medium">
                      <TypewriterEffect text="www.bandungcoding.com" />
                    </span>
                  </div>
                </a>
              </motion.div>
