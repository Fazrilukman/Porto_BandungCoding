...
const socialLinks = [
  ...
  },
  {
    ...
    url: "https://tiktok.com/@bandungcoding",
    color: "black",
...
const SocialLinks = () => {
  ...
  const [instagram, youtube, telegram, tiktok] = otherLinks;
          ...
          {[instagram, youtube].map((link, index) => (
            ...
            >
              ...
              <div className="flex flex-col min-w-0 flex-1">
                <span className="text-[11px] font-bold text-gray-200 group-hover:text-white transition-colors duration-300">
                  {link.displayName}
                </span>
                <span className="text-[9px] text-gray-400 group-hover:text-gray-300 transition-colors duration-300">
                  {link.subText}
                </span>
              </div>
